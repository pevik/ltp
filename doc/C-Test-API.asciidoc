...
NULL terminated array '.modprobe_module' of kernel module names are tried to be
loaded with 'modprobe' unless they are builtin or already loaded. Test exits
with 'TCONF' on first 'modprobe' non-zero exit. During cleanup are the modules
