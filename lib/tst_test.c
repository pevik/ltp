...
// TODO: to lib/tst_module_new.c
// TODO: https://patchwork.ozlabs.org/project/ltp/patch/20231013074748.702214-3-pvorel@suse.cz/
/*
...
static void do_cleanup(void)
{
	...
	if (tst_test->modprobe_module) {
		...
		for (i = 0; (name = tst_test->modprobe_module[i]); ++i) {
			...
			const char *const cmd_rmmod[] = {"modprobe", "-r", name, NULL};
			// TODO: handle TBROK on missing module => TCONF
